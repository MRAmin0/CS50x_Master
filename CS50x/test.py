...
list10 = ["twenty", "therty", "fourty", "fifty", "sixty", "seventy", "eighty", "ninety"]
hugeamount = [
    "hundered",
    "",
    "thousend",
...
def numtotext100(Number_text, list10, hugeamount, i):
    ...
    if size == 1:
        ...
        if ab >= 10 and ab < 20:
            ...
            out = (
                list10[int(number_list[-2]) - 2]
                + " "
                + Number_text[int(number_list[-1])]
            )
...
if len(list_num) == 1:
    ...
    while n <= len(list_num):
        if numtotext100(Number_text, list10, hugeamount, list_num[n - 1]) != "":
            out += (
                numtotext100(Number_text, list10, hugeamount, list_num[n - 1])
                + " "
                + hugeamount[s]
                + " "
            )
